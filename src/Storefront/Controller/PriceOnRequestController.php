...
class PriceOnRequestController extends StorefrontController
{
    ...
    public function send(Request $request, SalesChannelContext $context): JsonResponse
    {
        ...
        // The From address must be a mailbox this server is authorized to send as,
        // otherwise SPF/DKIM checks fail and the mail gets flagged as spoofed or
        // bounced. The customer's address goes into Reply-To instead so replies
